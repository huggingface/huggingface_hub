...
install_requires = [
    "filelock",
    "fsspec>=2023.5.0",
    "hf_xet==1.2.0rc1; platform_machine=='x86_64' or platform_machine=='amd64' or platform_machine=='AMD64' or platform_machine=='arm64' or platform_machine=='aarch64'",
    "httpx>=0.23.0, <1",
    "packaging>=20.9",
    "pyyaml>=5.1",
    "shellingham",
