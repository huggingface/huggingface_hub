...
install_requires = [
    "filelock",
    "fsspec>=2023.5.0",
    "hf_xet==1.1.10rc0; platform_machine=='x86_64' or platform_machine=='amd64' or platform_machine=='arm64' or platform_machine=='aarch64'",
    "packaging>=20.9",
    "pyyaml>=5.1",
    "requests",
    "tqdm>=4.42.1",
...
extras["hf_xet"] = ["hf_xet==1.1.10rc0"]
