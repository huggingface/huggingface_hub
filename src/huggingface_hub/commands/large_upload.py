...
class LargeUploadCommand(BaseHuggingfaceCLICommand):
    ...
    def register_subcommand(parser: _SubParsersAction):
        ...
        large_upload_parser.add_argument("--verbose", action="store_true", help="Whether to print debug information.")
    ...
    def run(self) -> None:
        ...
        print(
            ANSI.yellow(
                ...
                "\n"
                "Feedback is very welcome! Don't forget to report back how it went on https://github.com/huggingface/huggingface_hub"
            )
        )
