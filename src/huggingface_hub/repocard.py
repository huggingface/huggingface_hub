...
def metadata_eval_result(
    ...
    Args:
        ...
        metrics_config (`str`, *optional*):
            ...
            Example: bleurt-large-512 in `load_metric("bleurt",
            "bleurt-large-512")`.
        metrics_verified (`bool`, *optional*, defaults to `False`):
            Automatically computed, do not set. Dynamically overridden by
            Hugging Face in API calls to indicate if evaluation was verified by
            Hugging Face.
        metrics_token (`bool`, *optional*):
            Generated by Hugging Face to verify the results are valid.
        dataset_config (`str`, *optional*):
            Example: fr. The name of the dataset configuration used in
            `load_dataset()`.
        dataset_split (`str`, *optional*):
            Example: test. The name of the dataset split used in
            `load_dataset()`.
        dataset_revision (`str`, *optional*):
            Example: 5503434ddd753f426f4b38109466949a1217c2bb. The name of the
            dataset dataset revision used in `load_dataset()`.

    Returns:
        `dict`: a metadata dict with the result from a model evaluated on a
        dataset.
