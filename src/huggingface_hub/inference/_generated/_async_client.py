...
class AsyncInferenceClient:
    ...
    async def document_question_answering(
        ...
        *,
        ...
        >>> from huggingface_hub import AsyncInferenceClient
        >>> client = AsyncInferenceClient()
        >>> output = await client.document_question_answering(image="https://huggingface.co/spaces/impira/docquery/resolve/2359223c1837a7587402bda0f2643382a6eefeab/invoice.png"", question="What is the invoice number?")
        >>> output
