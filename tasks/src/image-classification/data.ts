...
const taskData: TaskData = {
	...
	summary:      "Image classification is to classify an entire image. The images are expected to have only one class instance in one image. Image classification models take an image as input and return class labels.",
