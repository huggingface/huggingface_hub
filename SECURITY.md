...
<!-- [OPTIONAL: code-execution sandbox — smolagents and similar] -->
...
<!-- [OPTIONAL: repos with conversion / CLI / dev utilities] -->
...
The following are **not** treated as vulnerabilities in `huggingface_hub`. If your finding touches one of these, the report must explain why it is nonetheless a violation of a guarantee we make — otherwise it will be closed.
...
- Findings in `scripts/`, documentation, tests, or other non-packaged reference material.
