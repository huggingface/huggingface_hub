...
For more advanced usage, [`scan_cache_dir`] is a python utility that scans your cache.
...
Here is a simple example of the returned format. See reference for details.
