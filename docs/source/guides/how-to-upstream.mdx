...
Once you've created a repository with the [`create_repo`](guides/how-to-manage#create-a-repository) function, you can upload a file to your repository with the [`upload_file`] function.
