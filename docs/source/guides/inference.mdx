...
All of these services can be called with the [`InferenceClient`] client. Let's see how to use it!
...
- audio
    ...
    - [x] [audio classification](../package_reference/inference_api#huggingface_hub.InferenceClient.audio_classification)
    - [x] [speech to text (automatic_speech_recognition)](../package_reference/inference_api#huggingface_hub.InferenceClient.audio_classification)
    - [x] text to speech
- computer vision
