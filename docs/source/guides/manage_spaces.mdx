...
[Streamlit Secrets Management](https://blog.streamlit.io/secrets-in-sharing-apps/) if using Streamlit).
You do not need the API to fetch the secrets dynamically.
</Tip>
...
this section, we will explore how to benefit from HF Spaces to finetune a model on demand.
