...
* `-v, --volume TEXT`: Mount a volume. Format: TYPE/SOURCE:/MOUNT_PATH[:ro]. TYPE is one of: model, dataset, space, bucket (or plural forms). E.g. -v models/gpt2:/data or -v buckets/my-org/my-bucket:/mnt:ro
